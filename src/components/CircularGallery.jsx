...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, imageWidth, imageHeight, imagePadding, zoom, cameraZ, cameraFOV]);
  return (
    <div
